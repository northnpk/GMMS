...
import { List, CheckBox, Report,FirstPage,KeyboardArrowLeft,KeyboardArrowRight,LastPage } from '@mui/icons-material'
                    ...
                    <TableBody>
                        {(rowsPerPage > 0
                            ...
                            <StyledTableRow key={row.Name}>
                                ...
                                <StyledTableCell align="center">{row.Mop1}</StyledTableCell>
                                <StyledTableCell align="center">{problemicon(row.Mop2)}</StyledTableCell>
                                <StyledTableCell align="center">
                                    <Grid>
                                        <ColorButton variant="contained" onClick={() => router.push('/Admin/confirm_page')} startIcon={<List />} sx={{ color: '#000000', width: 100, height: 40 }}>View</ColorButton>
                                    </Grid>
                                </StyledTableCell>
                            </StyledTableRow>
                        ))}
