...
export default function MyApp({ Topic_list, Op1, Op2,Op3,Op4, rows }) {
        ...
        <Table aria-label="customized table">
            <TableHead>
                <TableRow>
                    ...
                    <StyledTableCell align="center">{Op3}</StyledTableCell>
                    <StyledTableCell align="center">{Op4}</StyledTableCell>
                </TableRow>
            </TableHead>
            <TableBody>
                {rows.slice((page - 1) * 5, page * 5).map((row, i) => (
                    <StyledTableRow key={i}>
                        ...
                        <StyledTableCell align="center">{row.Machine_name}</StyledTableCell>
                        <StyledTableCell align="center">{row.Machine_Type}</StyledTableCell>
                        <StyledTableCell align="center">{row.Detail}</StyledTableCell>
                        <StyledTableCell align="center">{row.Error_count}</StyledTableCell>
                    </StyledTableRow>
                ))}
            </TableBody>
            <TableFooter>
